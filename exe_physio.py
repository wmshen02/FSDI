...
from main_model_new import FSDI_Physio
from dataset_physio import get_dataloader
from utils import train, evaluate
import logging
from hook import register_pyramid_hooks
...
logging.info("FSDI")
parser = argparse.ArgumentParser(description="FSDI")
...
after_forward = register_pyramid_hooks(model, show_plot=True)
